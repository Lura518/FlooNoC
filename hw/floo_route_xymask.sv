...
// This module is the heartpiece for collectiv operation in the FlooNoC. When running an multicast / reduction it either
// determines the output direction of the filt (e.g. in which direction a copy of the filt has to be sent) or the expected
